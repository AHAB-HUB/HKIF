...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
            ...
            switch (menuItem.getItemId()) {
                ...
                case id.bottom_nav_findUs:
                    getSupportFragmentManager().beginTransaction().replace(id.fragment_container, new LocationFragment()).addToBackStack(null).commit();
                    break;
                case id.bottom_nav_schedule:
                    getSupportFragmentManager().beginTransaction().replace(id.fragment_container, new DaysFragment()).addToBackStack(null).commit();
                    break;
            }
            return true;
        }
    ...
    public void contactDialog() {
        ...
        imagePhone = alertView.findViewById(R.id.contact_phone);
        imageMessage = alertView.findViewById(R.id.contact_message);
        cancelButton = alertView.findViewById(R.id.cancel_contact);
